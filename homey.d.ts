declare module 'homey' {
    ...
    export class Device {
        ...
        setEnergy(energy: Record<string, any>): Promise<void>;
        getEnergy?(): Record<string, any> | null;
    }
    export class Driver {
        homey: HomeyAppContext;
        log(...args: any[]): void;
        ...
        onRepair(session: any, device: Device): void;
    ...
    export interface FlowCardAction {
        registerRunListener(listener: (args: any, state: any) => Promise<boolean> | boolean): this;
    }
