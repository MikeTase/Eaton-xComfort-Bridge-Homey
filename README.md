...
It supports switching and dimming actuators, shading control (open/close/stop with optional position), thermostat setpoints with synced Frost/Economy/Comfort presets, temperature and humidity sensors, door and window sensors, room status sensors, wall switch button events, water sensors, and bridge diagnostics.
