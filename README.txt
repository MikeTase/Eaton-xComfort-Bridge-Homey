...
It supports switching and dimming actuators, shading control (open/close/stop with optional position), thermostat setpoints, wall switch button events, water sensors, and bridge diagnostics.
